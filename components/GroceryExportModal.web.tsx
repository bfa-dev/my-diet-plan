...
export function GroceryExportModal({
  ...
  const exportToPDF = async () => {
    try {
      ...
      link.href = url;
      link.download = `alisveris-listesi-${new Date().toISOString().split('T')[0]}.html`;
      ...
      Alert.alert('Başarılı!', 'Alışveriş listesi HTML dosyası olarak indirildi. Bu dosyayı tarayıcınızda açıp yazdırabilirsiniz.');
    } catch (error) {
        ...
        <View style={styles.content}>
          ...
          <View style={styles.options}>
            ...
            >
              ...
              <View style={styles.optionContent}>
                <Text style={styles.optionTitle}>HTML Olarak İndir</Text>
                <Text style={styles.optionDescription}>
                  Yazdırılabilir HTML dosyası oluştur
                </Text>
              </View>
            </TouchableOpacity>
          ...
          <View style={styles.tips}>
            ...
            <Text style={styles.tipsText}>
              • HTML dosyasını tarayıcınızda açıp yazdırabilirsiniz{'\n'}
